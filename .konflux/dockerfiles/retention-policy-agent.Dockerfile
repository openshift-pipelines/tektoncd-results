...
LABEL \
    com.redhat.component="openshift-pipelines-results-retention-policy-agent-rhel10-container" \
    ...
    name="openshift-pipelines/pipelines-results-retention-policy-agent-rhel10" \
